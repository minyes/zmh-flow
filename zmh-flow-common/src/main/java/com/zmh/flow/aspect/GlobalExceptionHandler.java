...
import com.zmh.flow.excption.FlowException;
import com.zmh.flow.result.Result;
import com.zmh.flow.result.ResultCode;
...
public class GlobalExceptionHandler {
    ...
    public Result bizExceptionHandler(FlowException e, HttpServletRequest request) {
